...
check('seo & cms: 119 concepts preserved (none deleted)', SC && SC.terms.length === 119, SC && SC.terms.length + '');
...
check('seo & cms: 44 priority concepts featured', SC.featuredTerms.length === 44, SC.featuredTerms.length + '');
check('seo & cms: only featured concepts merged into deck', seoCards.length === SC.featuredTerms.length, seoCards.length + ' merged');
check('seo & cms: 75 concepts preserved but unsurfaced', SC.terms.length - SC.featuredTerms.length === 75);
